...
def process_meta(task):
    ...
    np.save(f'{DATASET_DIR}numenta/metafeatures/{dataset}.npy', meta_features)
...
def main():
    ...
    # tasks = [
    #     (d, datasets_seasonality[d])
    #     for d in test_datasets
    #     if not os.path.exists(f'{DATASET_DIR}numenta/metafeatures/{d}.npy')
    # ]
